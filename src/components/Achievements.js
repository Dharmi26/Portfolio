    ...
    return(
        ...
        {/* <div>
            ...
            <div className='st1 mt-5 mb-5 d-flex flex-row gap-5 flex-wrap justify-content-center align-items-center'>
                <div className='position-relative st shadow p-3 mb-5 rounded w-50 d-flex flex-column gap-3 justify-content-center align-items-center'>
                    <img src={require("../assets/target1.png")} width="100" className='d-none d-md-block ms-2 position-absolute start-0 top-0'/>
                ...
                <div className='position-relative st shadow p-3 mb-5 rounded w-50 d-flex flex-column gap-3 justify-content-center align-items-center'>
                    <img src={require("../assets/target.png")} width="100" className='d-none d-md-block position-absolute start-0 top-0'/>
                ...
                <div className='position-relative st shadow p-3 mb-5 rounded w-50 d-flex flex-column gap-3 justify-content-center align-items-center'>
                    <img src={require("../assets/target2.png")} width="90" className='d-none d-md-block position-absolute start-0 top-0'/>
...
<div class="container">
  ...
  <div class="st1 mt-5 mb-5 d-flex flex-row gap-5 flex-wrap justify-content-center align-items-center">
    <div class="position-relative st shadow p-3 mb-5 rounded w-100 w-md-50 d-flex flex-column gap-3 justify-content-center align-items-center">
